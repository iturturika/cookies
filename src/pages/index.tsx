...
export default function IndexPage() {
  ...
  return (
    <DefaultLayout>
      <Header />
      <section className="w-11/12 mx-auto flex gap-x-8">
        <div className="w-3/5 flex flex-col h-80 gap-y-3" >
          <div 
          ...
          <div className="flex gap-1">
            <div className="rounded-l-md bg-slate-700 h-20 px-3 py-3 w-2/5 flex flex-col justify-between">
              ...
              <div className="w-full flex items-center justify-between">
                <p className="text-md font-medium text-slate-400 flex gap-x-1">₽
                  <input className="outline-none border-none bg-inherit w-1/3 text-white font-medium" value={'10'}/>
                </p>

                <div className="flex gap-x-2">
                  <img src={half} alt="half" className="w-7 p-2 rounded-md bg-slate-600 hover:bg-slate-100 cursor-pointer"/>
                  <img src={x2} alt="half" className="w-7 p-2 rounded-md bg-slate-600 hover:bg-slate-100 cursor-pointer"/>
                </div>
              </div>
            </div>

            <div className="rounded-r-md bg-slate-700 h-20 px-3 py-3 w-2/5 flex flex-col justify-between">
            ...
            <div className="rounded-md ml-1 bg-blue-600 h-20 px-3 py-3 w-1/5 flex justify-center items-center cursor-pointer button_active">
                <p className="text-lg font-semibold text-white">СТАВКА</p>
            </div>
            
          </div>
        </div>
        <div className="flex w-2/5 flex-col gap-y-5">
      ...
      <footer className="w-full mx-auto flex flex-col py-16 gap-y-6" style={{backgroundColor: '#111720'}}>
        <div className="w-11/12 mx-auto flex gap-x-32">
